    ...
    <div className="each-sections">
      ...
      <div className="search-userdiv">
        ...
        <div className="count-slider">
          <div>
            <button onClick={prePage} className="side-btn">
              <FaCaretLeft className="side-arrow" />
            </button>
          </div>
          ...
          <div>
            <button onClick={nextPage} className="side-btn">
              <FaCaretRight className="side-arrow" />
            </button>
          </div>
          <div className="pipe">|</div>
          <div>
          ...
          <tbody>
            <tr>
              ...
              <th>
                Name{" "}
                <span>
                  <FaSortDown className="arrowdown" />
                </span>
              ...
              >
                ...
                <td>
                  {user.Status === "Available" ? (
                    ...
                    <span className="disturb">
                      <TiMinus />
                    </span>
                  ) : user.Status === "Appear away" ? (
                    <span className="appear-away">
                      <CiClock1 />
                    </span>
                  ) : user.Status === "Busy" ? (
